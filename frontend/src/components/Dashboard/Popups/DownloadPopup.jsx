    ...
    return (
        <div
            ...
            <div className="bg-white py-[2vw] px-[1vw] rounded-lg">
                <h2 className="text-[4vw] font-satoshi font-bold mb-4 md:text-[1.5vw]">Choose Quality</h2>
                ...
                <div className="flex items-center justify-between mb-4">
                    <label htmlFor="png" className="flex items-center space-x-2">
                        ...
                        <div className="flex flex-col">
                            <span className="text-[4vw] text-teal-600 font-satoshi md:text-[1vw]">Download as PNG</span>
                            <span className="text-[4vw] text-gray-500 font-satoshi md:text-[0.8vw]">Lower quality and size</span>
                        </div>
                    </label>
                    <input
                        type="checkbox"
                ...
                <div className="flex items-center justify-between space-x-2 mb-6">
                    <label htmlFor="jpg" className="flex items-center space-x-2">
                        ...
                        <div className="flex flex-col">
                            <div
                                className="text-[4vw] text-indigo-400 font-satoshi flex items-center gap-[0.5vw] md:text-[1vw]">Download as JPG
                                <PiCrownFill size={20} className="text-yellow-300"/>
                            </div>
                            <span className="text-[4vw] text-gray-500 font-satoshi md:text-[0.8vw]">Best quality and bigger file size</span>
                        </div>
                    </label>
                    <input
                        type="checkbox"
