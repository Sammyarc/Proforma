...
const Export = ({ onExportPDF, onExportEmail, isExporting }) => {
  ...
  return (
    <div className="absolute z-[10] right-0 mt-[1vw] w-64 bg-white text-black rounded-md shadow-lg md:w-[25vw] md:rounded-lg animate-moveUp">
      <div className="bg-white py-[2vw] px-[1vw] rounded-lg">
        ...
        <div className="flex items-center justify-between mb-4">
          <label htmlFor="pdf" className="flex items-center space-x-2">
            ...
            <div className="flex flex-col">
              <span className="text-[4vw] text-teal-600 font-satoshi md:text-[1vw]">Export as PDF</span>
              <span className="text-[4vw] text-gray-500 font-satoshi md:text-[0.8vw]">Standard document format</span>
            </div>
          </label>
          <input
            type="checkbox"
        ...
        <div className="flex items-center justify-between space-x-2 mb-6">
          <label htmlFor="email" className="flex items-center space-x-2">
            ...
            <div className="flex flex-col">
              <span className="text-[4vw] text-zinc-800 font-satoshi md:text-[1vw]">Generate and send as Email</span>
              <span className="text-[4vw] text-gray-500 font-satoshi md:text-[0.8vw]">Send to clients via email</span>
            </div>
          </label>
          <input
            type="checkbox"
