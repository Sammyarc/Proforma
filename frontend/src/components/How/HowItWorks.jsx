...
const HowItWorks = () => {
    ...
    return (
        <section className="py-10 px-[4vw] relative overflow-hidden md:py-16">
            <h2 className="text-center text-[8vw] font-bold mb-[6vw] font-satoshi md:text-[3vw]">How It Works</h2>
            <div>
                        ...
                        steps.map((step, index) => (
                            <div
                                ...
                                className={`flex flex-col ${index % 2 !== 0
                                    ...
                                    : 'md:flex-row md:mr-[10vw]'} items-center gap-[5vw]`}>
                                <div
                                    ...
                                    <img
                                        src={step.imageSrc}
                                        className="w-[100vw] h-full object-cover md:w-[90vw]"
                                        alt={step.imageAlt}/>
                                </div>

                                <div className="w-full md:w-1/2 text-left">
                                    <div className="relative text-gray-600 border-b border-gray-600 w-32">
                                        <span className="text-[9vw] font-satoshi md:text-[4vw]">0</span>
                                        <span className="absolute text-[8vw] top-[4vw] font-clash md:text-[3.5vw] md:top-[2vw]">{step.id}</span>
                                    </div>
