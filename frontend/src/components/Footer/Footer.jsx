    ...
    return (
        <footer className="py-8 mt-[4vw]">
            <div className="container mx-auto px-6">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li>
                                    <a
                                        href="#features"
                                        className="hover:text-Gray800 font-satoshi text-[4vw] transition-colors md:text-[1vw]">Features</a>
                                </li>
                                <li>
                                    <a
                                        href="#pricing"
                                        className="hover:text-Gray800 font-satoshi text-[4vw] transition-colors md:text-[1vw]">Pricing</a>
                                </li>
                                <li>
                                    <a
                                        href="#support"
                                        className="hover:text-Gray800 font-satoshi text-[4vw] transition-colors md:text-[1vw]">Support</a>
                                </li>
                                <li>
                                    <a
                                        href="#contact"
                                        className="hover:text-Gray800 font-satoshi text-[4vw] transition-colors md:text-[1vw]">Contact Us</a>
                                </li>
                            </ul>
                        </div>
                ...
                {/* Copyright */}
                <div
                    className="border-t border-gray-600 mt-8 pt-6 text-center font-satoshi text-base">
                    <p>&copy; <span className="mr-1">{new Date().getFullYear()}</span>
                         Proforma. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    );
