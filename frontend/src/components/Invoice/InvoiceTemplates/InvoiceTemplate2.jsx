        ...
        <div>
            ...
            <div className="grid grid-cols-3 space-x-[9vw] mb-8">
                ...
                <div className='flex flex-col space-y-1'>
                    <p className='text-gray-600 text-[4vw] font-satoshi md:text-[1vw]'>Invoice of (USD)</p>
                    <span className='text-[6vw] text-orange-500 font-bold font-satoshi md:text-[1.7vw]'>${total.toFixed(2)}</span>
                </div>
            ...
            <table className="w-full mb-8">
                <thead>
                    <tr className="border-b">
                        <th className="text-left text-[4vw] p-2 font-satoshi md:text-[1vw]">DESCRIPTION</th>
                        <th className="text-left text-[4vw] p-2 font-satoshi md:text-[1vw]">QTY</th>
                        <th className="text-left text-[4vw] p-2 font-satoshi md:text-[1vw]">RATE</th>
                        <th className="text-right text-[4vw] p-2 font-satoshi md:text-[1vw]">AMOUNT</th>
                    </tr>
                </thead>
                <tbody>
                        {
            ...
            <div className="mt-8 px-4 text-gray-500">
                        <div
                            className="text-gray-800 text-[4vw] font-bold font-satoshi md:text-[1vw]">Terms & Conditions
                        </div>
                        <p
                            className="block w-full text-[4vw] font-satoshi py-2 text-gray-500 focus:outline-none md:text-[1vw]">
