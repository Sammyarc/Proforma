        ...
        <div>
            ...
            <div className="flex justify-between mb-[5vw]">
                <div className='flex flex-row items-center space-x-[1vw]'>
                    ...
                    <div className="space-y-1">
                        ...
                        <div
                            ...
                            onInput={(e) => handleFieldChange('businessEmail', e.target.textContent)}>
                            hello@email.com
                        </div>
                        <div
                            contentEditable
                            className="block w-full text-[4vw] text-gray-500 font-satoshi focus:outline-none border-b border-transparent hover:border-gray-300 md:text-[1vw]"
                            onInput={(e) => handleFieldChange('businessContactInfo', e.target.textContent)}>
                            +91 00000 00000
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <h1 className="text-[4vw] font-extrabold font-satoshi leading-none text-gray-400 md:text-[2.5vw]">Invoice</h1>
            ...
            <div className="grid grid-cols-3 space-x-[5vw] mb-[5vw]">
                <div>
                    <h2 className="text-[4vw] font-satoshi font-bold uppercase text-gray-400 mb-2 md:text-[1vw]">Billed to:</h2>
                ...
                <div className="flex flex-col h-full justify-between">
                    <div className="flex flex-col space-y-[0.5vw]">
                        <h2 className="text-gray-400 text-[4vw] font-satoshi uppercase md:text-[1vw]">Invoice Date:</h2>
                        <div>
                        {
                        isStaticMode
                            ? (
                                <p className='text-[4vw] font-satoshi -mt-[0.7vw] md:text-[1vw]'>{invoiceData.invoiceDate || ""}</p>
                            )
                            : (
                                <input
                                    type="date"
                    ...
                    <div className="flex flex-col space-y-[0.5vw]">
                        <h2 className="text-gray-400 text-[4vw] font-satoshi uppercase md:text-[1vw]">Due Date:</h2>
                        <div>
                        {
                        isStaticMode
                            ? (
                ...
                <div className='flex flex-col justify-end space-y-1'>
                    <p className='text-gray-600 text-[4vw] text-center uppercase font-satoshi md:text-[1vw]'>Amount Due</p>
                    <div className="bg-yellow-200 -mr-[2vw] px-3 py-1">
                        <p className='text-[6vw] text-orange-500 font-bold font-satoshi md:text-[1.7vw]'>${formatCurrency(total)}</p>
                    </div>
                </div>
            </div>
                                        ...
                                        <td className="relative px-2 pb-4">
                                            {
                                                isStaticMode
                                                    ...
                                                    : (
                                                        <div
                                                            className="absolute top-1/2 right-4 transform -translate-y-1/2 hidden group-hover:flex transition-opacity duration-200">
                                                            <button
