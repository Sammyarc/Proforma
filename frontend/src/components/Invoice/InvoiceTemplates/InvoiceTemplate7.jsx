        ...
        <div>
            ...
            <div className="flex justify-between items-center mb-[3vw]">
                <div
                    ...
                    <h1 className="text-[4vw] font-extrabold font-satoshi leading-none uppercase md:text-[2.5vw]">Invoice</h1>
                    { isStaticMode ? (<p className="text-[4vw] text-gray-600 font-satoshi md:text-[1vw]"> {invoiceData.invoiceNumber || "#AB2324-01"} </p>) 
                    :(<p
                        contentEditable
            ...
            <div className="grid grid-cols-3">
                ...
                <div className="flex flex-col h-full justify-between p-[1vw] border-t-2 border-r-2 border-b-2">
                    <div className="flex flex-col">
                       <div className="text-[4vw] font-bold font-satoshi md:text-[1vw]">Issued:
                       </div>
                        {
                        isStaticMode
                            ? (
                                <p className='text-[4vw] font-satoshi md:text-[1vw]'>{invoiceData.date || ""}</p>
                            )
                            : (
                                <input
                                    type="date"
                    ...
                    <div className='flex flex-col'>
                        <p className="text-[4vw] font-bold leading-none font-satoshi md:text-[1vw]">Due:</p>
                            {
                                isStaticMode
                                    ? (
                                        <p className='text-[4vw] font-satoshi -mt-[0.7vw] md:text-[1vw]'>{invoiceData.dueDate || ""}</p>
                                    )
                                    : (
                                        <input
                                            type="date"
                ...
                <div className="p-[1vw] border-t-2 border-r-2 border-b-2">
                        <h2
                            className="text-[4vw] font-satoshi font-semibold text-gray-900 mb-2 md:text-[1vw]">Billed To:</h2>
            ...
            <div className="mt-4 space-y-2">
                ...
                <div className="flex ml-auto w-[15vw]">
                    <span className="w-[9vw] text-[4vw] font-bold font-satoshi md:text-[1vw]">Total</span>
                    <span className="w-[9vw] text-right text-[4vw] font-bold font-satoshi md:text-[1vw]">{formatCurrency(total)}</span>
                </div>
                <div className="flex ml-auto w-[15vw] uppercase text-gray-600">
                    <span className="w-[9vw] text-[4vw] font-bold font-satoshi md:text-[1vw]">Amount due</span>
                    <span className="w-[9vw] text-right text-[4vw] font-bold font-satoshi md:text-[1vw]">USD ${formatCurrency(total)}</span>
                </div>
            ...
            <div className="mt-[3vw]">
                <div>
                    <h3 className="font-bold mb-1 text-[4vw] font-satoshi md:text-[1vw]">Thanks for the business.</h3>
                ...
                <div className="flex justify-end items-center space-x-[1vw]">
                    { isStaticMode ? (<p className="text-gray-600 text-[4vw] font-satoshi md:text-[1vw]">{invoiceData.email || "hello@email.com"}</p>) : (<span
                        contentEditable
                    ...
                    { isStaticMode ? (<p className="text-gray-600 text-[4vw] font-satoshi md:text-[1vw]">{invoiceData.contactPhone || "+91 00000 00000"}</p>) :(<span
                        contentEditable
                        className="text-[4vw] text-gray-500 font-satoshi focus:outline-none border-b border-transparent hover:border-gray-300 md:text-[1vw]"
