    ...
    <div>
      ...
      <div className="flex justify-between items-center mb-[3vw]">
        <div className="flex flex-col">
          <h1 className="text-[4vw] font-extrabold font-satoshi leading-none uppercase md:text-xl lg:text-[2.5vw]">
            Invoice
          </h1>
          {isStaticMode ? (
            <p
      ...
      <div className="grid grid-cols-3">
        ...
        <div className="flex flex-col h-full justify-between p-[1vw] border-t-2 border-r-2 border-b-2">
          <div className="flex flex-col">
            <div className="text-[4vw] font-bold font-satoshi md:text-base lg:text-[1vw]">
              Issued:
            </div>
            {isStaticMode ? (
              <p
              ...
              <input
                type="date"
                data-invoice-field="invoiceDate"
                className="focus:outline-none w-[15vw] border-b border-transparent bg-transparent hover:border-gray-300 text-[4vw] text-gray-600 font-satoshi md:text-base lg:w-[7.5vw] lg:text-[1vw]"
          ...
          <div className="flex flex-col">
            <p className="text-[4vw] font-bold leading-none font-satoshi md:text-base lg:text-[1vw]">
              Due:
            </p>
            {isStaticMode ? (
              <p
              ...
              <input
                type="date"
                data-invoice-field="dueDate"
                className="focus:outline-none w-[15vw] border-b border-transparent bg-transparent mt-[0.3vw] hover:border-gray-300 text-[4vw] text-gray-600 font-satoshi md:text-base lg:w-[7.5vw] lg:text-[1vw]"
        ...
        <div className="p-[1vw] border-t-2 border-r-2 border-b-2">
          <h2 className="text-[4vw] font-satoshi font-semibold text-gray-900 mb-2 md:text-base lg:text-[1vw]">
            Billed To:
          </h2>
        ...
        <div className="p-[1vw] border-t-2 border-b-2">
          ...
          <div className="space-y-2">
            ...
            <div className="flex space-x-[0.5vw]">
              ...
              {isStaticMode ? (
                <div className="text-[4vw] font-satoshi md:text-base lg:text-[1vw]">
              ...
              <tr key={index} className="border-b group relative">
                <td>
                  {isStaticMode ? (
                    ...
                    <input
                      type="text"
                      data-invoice-field="description"
                      className="w-[35vw] px-4 py-3 focus:outline-none bg-transparent text-[4vw] font-satoshi md:text-base lg:text-[1vw]"
                ...
                <td>
                  {isStaticMode ? (
                    ...
                    <input
                      type="number"
                      className="w-full px-4 py-3 focus:outline-none bg-transparent text-[4vw] font-satoshi md:text-base lg:text-[1vw]"
                      value={item.qty}
                      placeholder="1"
                      onChange={(e) =>
                        handleItemChange(
      ...
      {isStaticMode ? (
        ...
        <button
          onClick={addNewItem}
          className="flex items-center gap-2 text-blue-400 my-3 text-[4vw] font-satoshi md:text-base lg:text-[1vw]"
        >
          <Plus size={16} />
          Add Line Item
        </button>
      ...
      <div className="mt-4 space-y-2">
        <div className="flex justify-between ml-auto w-[25vw] text-gray-600 lg:w-[15vw]">
          <span className="text-[4vw] font-satoshi md:text-base lg:text-[1vw]">
            Subtotal:
          </span>
          <span className="text-right text-[4vw] font-satoshi md:text-base lg:text-[1vw]">
        ...
        <div className="flex justify-between ml-auto w-[25vw] lg:w-[15vw]">
          <span className="text-[4vw] font-bold font-satoshi md:text-base lg:text-[1vw]">
            Total
          </span>
          <span
            className="text-right text-[4vw] font-bold font-satoshi md:text-base lg:text-[1vw]"
            data-invoice-field="invoiceAmount"
          >
            {formatCurrency(total)}
          </span>
        </div>
        <div className="flex justify-between ml-auto w-[25vw] uppercase text-gray-600 lg:w-[15vw]">
          <span className="text-[4vw] font-bold font-satoshi md:text-base lg:text-[1vw]">
            Amount due
          </span>
          <span className="text-right text-[4vw] font-bold font-satoshi md:text-base lg:text-[1vw]">
            USD ${formatCurrency(total)}
          </span>
        </div>
        <div className="h-[0.2vw] w-[25vw] ml-auto bg-purple-600 mt-4 lg:w-[15vw]"></div>
      </div>
      ...
      <div className="mt-[3vw]">
        <div>
          ...
          <p className="text-gray-600 mb-2 text-[4vw] font-satoshi md:text-base lg:text-[0.9vw]">
        ...
        <div className="flex justify-end items-center space-x-[1vw]">
          {isStaticMode ? (
            <p
              className="text-gray-600 text-[4vw] font-satoshi md:text-base lg:text-[1vw]"
            ...
            <span
              contentEditable
              data-invoice-field="companyAddress"
              className="text-[4vw] text-gray-500 font-satoshi focus:outline-none border-b border-transparent hover:border-gray-300 md:text-base lg:text-[1vw]"
              onInput={(e) =>
          ...
          {isStaticMode ? (
            <p className="text-gray-600 text-[4vw] font-satoshi md:text-base lg:text-[1vw]">
