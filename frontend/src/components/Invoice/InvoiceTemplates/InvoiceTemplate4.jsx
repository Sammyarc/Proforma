    ...
    <div>
      ...
      <div className="flex justify-between mb-12">
        <div className="space-y-4">
          <h1 className="text-[4vw] font-clash font-bold md:text-[2.2vw]">
            Invoice
          </h1>
          <div>
      ...
      <div className="grid grid-cols-6 gap-8 mb-8">
        <div className="col-span-1 space-y-8 pr-[1vw] border-r-2 border-gray-200">
          <div className="flex flex-col">
            <p className="text-[4vw] font-bold font-satoshi md:text-[1vw]">
              Invoice No:
            </p>
            <p
              contentEditable
          ...
          <div className="flex flex-col">
            ...
            {isStaticMode ? (
              <p className="text-[4vw] font-satoshi md:text-[1vw]" data-invoice-field="invoiceDate">
          ...
          <div className="flex flex-col">
            ...
            {isStaticMode ? (
              <p className="text-[4vw] font-satoshi md:text-[1vw]" data-invoice-field="dueDate">
                {invoiceData.dueDate || ""}
              </p>
            ) : (
              <input
            ...
            <tbody>
              {invoiceData.items.map((item, index) => (
                <tr key={index} className="border-b group relative">
                  <td>
                    {isStaticMode ? (
                      <p className="text-[4vw] w-[25vw] px-4 py-2 font-satoshi md:text-[1vw]" data-invoice-field="description">
                        {item.description || ""}
                      </p>
                    ) : (
                      <input
