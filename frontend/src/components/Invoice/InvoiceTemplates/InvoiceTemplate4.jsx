    ...
    return (
        <div>
            ...
            <div className="flex justify-between mb-12">
                ...
                <h1 className="text-[4vw] font-clash font-bold md:text-[2.2vw]">Invoice</h1>
                <div>
            ...
            <div className="grid grid-cols-6 gap-8 mb-8">
                <div className="col-span-1 space-y-8 pr-[1vw] border-r-2 border-gray-200">
                    <div className="flex flex-col">
                        <p className="text-[4vw] font-bold font-satoshi md:text-[1vw]">Invoice No:</p>
                            <p
                                contentEditable
                    ...
                    <div className='flex flex-col'>
                      <p className="text-[4vw] font-bold font-satoshi md:text-[1vw]">Invoice Date:</p>
                            {
                                isStaticMode
                                    ? (
                    ...
                    <div className="flex flex-col">
                        <p className="text-[4vw] font-bold font-satoshi md:text-[1vw]">Reference:</p>
                            <p
                                contentEditable
                                className="focus:outline-none border-b border-transparent hover:border-gray-300 text-[4vw] text-gray-600 font-satoshi md:text-[1vw]"
                    ...
                    <div className='flex flex-col'>
                        <p className="text-[4vw] font-bold font-satoshi md:text-[1vw]">Due Date:</p>
                            {
                                isStaticMode
                                    ? (
                ...
                <table className="w-full">
                                                                ...
                                                                <td>
                                                                    {
                                                                        isStaticMode
                                                                            ? (
                                                                                <p className='text-[4vw] w-[25vw] px-4 py-2 font-satoshi md:text-[1vw]'>{item.description || ""}</p>
                                                                            )
                                                                            : (
                                                                                <input
                                                                                    type="text"
                                                                                    className="w-[25vw] px-4 py-3 focus:outline-none text-[4vw] font-satoshi md:text-[1vw]"
                    ...
                    <div className="flex flex-col items-end space-y-[1vw] mt-[3vw] mr-[2vw]">
                       <div className="flex justify-between w-[20vw]">
                            ...
                            <span className='text-[4vw] font-satoshi md:text-[1vw]'>${formatCurrency(subtotal)}</span>
                       </div>
                       <div className="flex justify-between w-[20vw]">
                            <span className='text-[4vw] font-satoshi md:text-[1vw]'>Tax (10%):</span>
                            <span className='text-[4vw] font-satoshi md:text-[1vw]'>${formatCurrency(tax)}</span>
                       </div>
                       <div className="h-[0.1vw] w-[20vw] ml-auto bg-gray-200 mt-4"></div>
            ...
            <div className="mt-12">
                ...
                <div className="flex justify-between text-gray-600 border-t pt-2">
                        <div
                            contentEditable
                            className="block w-full text-[4vw] text-gray-500 font-satoshi focus:outline-none border-b border-transparent hover:border-gray-300 md:text-[1vw]"
                            onInput={(e) => handleFieldChange('businessWebsite', e.target.textContent)}>
                            www.website.com
                        </div>
                        <div
                            contentEditable
                            className="block text-center w-full text-[4vw] text-gray-500 font-satoshi focus:outline-none border-b border-transparent hover:border-gray-300 md:text-[1vw]"
                            onInput={(e) => handleFieldChange('contactPhone', e.target.textContent)}>
                            +91 00000 00000
                        </div>
                        <div
                            contentEditable
                            className="block text-right w-full text-[4vw] text-gray-500 font-satoshi focus:outline-none border-b border-transparent hover:border-gray-300 md:text-[1vw]"
