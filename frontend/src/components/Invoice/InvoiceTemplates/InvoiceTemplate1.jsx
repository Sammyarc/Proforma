...
const InvoiceTemplate1 = ({ isStaticMode }) => {
  ...
  return (
      <div>
      <div
        className="relative group w-[12vw] h-[12vw] lg:w-[8vw] lg:h-[8vw] rounded-md flex items-center justify-center cursor-pointer"
      ...
      >
        {invoiceData.companyLogo ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-md text-gray-400 w-[12vw] h-[12vw] lg:w-[8vw] lg:h-[8vw] border-2 border-dashed border-gray-300 hover:border-gray-400">
            <FiUpload size={24} />
      ...
      <div className="flex justify-between items-start my-[1.5vw]">
        <div className="space-y-2">
          <div
            contentEditable
            className="block text-[5vw] w-full font-bold font-satoshi focus:outline-none py-1 border-b border-transparent hover:border-gray-300 md:text-lg lg:text-[1.5vw]"
          ...
          <div
            contentEditable
            className="block w-full text-[4vw] text-gray-500 font-satoshi focus:outline-none py-1 border-b border-transparent hover:border-gray-300 md:text-base lg:text-[1vw]"
        ...
        <div className="text-[6vw] font-clash font-bold text-Gray900 md:text-[4vw] lg:text-[3vw]">
          INVOICE
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-[10vw] mb-8">
        <div className="space-y-2">
          <div className="text-[4vw] font-satoshi font-semibold text-gray-600 mb-2 md:text-lg lg:text-[1vw]">
            Billed To:
          </div>
          ...
          <div className="grid grid-cols-2 items-center">
            ...
            {isStaticMode ? (
              ...
              <input
                type="date"
                data-invoice-field="invoiceDate"
                className="focus:outline-none w-[13vw] border-b border-transparent py-1 hover:border-gray-300 text-[4vw] text-gray-600 font-satoshi md:text-base lg:text-[1vw] lg:w-[7.5vw]"
      ...
      <div className="space-y-4 mb-8">
        <div>
          <div className="text-gray-800 mb-1 text-[4vw] font-bold font-satoshi md:text-base lg:text-[1vw]">
            Notes
          </div>
