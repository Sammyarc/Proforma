  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-start my-[1.5vw]">
        ...
        <div className="text-[6vw] font-clash font-bold text-Gray900 md:text-[3vw]">
          INVOICE
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-[10vw] mb-8">
        <div className="space-y-2">
          <div className="text-[4vw] font-satoshi font-semibold text-gray-600 mb-2 md:text-[1vw]">
            Billed To:
          </div>
      ...
      <div className="space-y-4 mb-8">
        <div>
          <div className="text-gray-800 mb-1 text-[4vw] font-bold font-satoshi md:text-[1vw]">
            Notes
          </div>
