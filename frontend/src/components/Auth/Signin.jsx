  ...
  return (
    ...
    >
      <div className="w-[90vw] md:w-[30vw] flex flex-col mx-auto my-[8vw] bg-White shadow-xl px-[2.5vw] py-[7vw] md:p-[2vw] rounded-[0.5vw]">
        ...
        {error && (
          <p className="text-red-500 flex items-center gap-1 font-medium text-[4vw] md:text-[1vw] mt-2 font-satoshi">
            <MdErrorOutline className="text-[5vw] md:text-[1.2vw]" /> {error}
          </p>
        )}
          ...
          {isRegister ? (
            ...
            <label className="flex items-center space-x-2 cursor-pointer">
              <input
                ...
                className="h-[4.5vw] w-[4.5vw] md:h-[1vw] md:w-[1vw] rounded-[0.2vw] accent-Gray800 cursor-pointer"
              />
              <span className="text-[4vw] md:text-[0.9vw] text-Gray700 font-satoshi">
                Remember Me
              </span>
            </label>
          )}
        ...
        <div className="flex flex-col mt-[4vw] md:mt-[1vw]">
          <div className="flex items-center mb-[4vw] md:mb-[1vw]">
            ...
            <span className="text-Gray800 text-[3.5vw] md:text-[1vw] font-satoshi">
              OR
            </span>
